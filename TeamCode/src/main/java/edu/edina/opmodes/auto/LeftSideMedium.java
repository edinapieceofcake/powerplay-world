...
public class LeftSideMedium extends AutoBase {
    ...
    public static Vector2d STACK_3 = new Vector2d(STACK_X -.25, STACK_Y - .75);
    public static Vector2d D2_3 = new Vector2d(D2_X, D2_Y -.25);
    public static Vector2d STACK_4 = new Vector2d(STACK_X -.25, STACK_Y - .75);
    public static Vector2d D2_4 = new Vector2d(D2_X, D2_Y -.25);
    public static Vector2d STACK_5 = new Vector2d(STACK_X -.25, STACK_Y - .75);
