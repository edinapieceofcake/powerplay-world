...
public class RightSideHigh extends AutoBase {
    protected static double STACK_X = 56;
    protected static double STACK_Y = -11.5;
    protected static double DISTANCE = 39.0;
    public static Vector2d D2 = new Vector2d(31.5, -21.75);
